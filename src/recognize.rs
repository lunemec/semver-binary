// This file is copied from https://github.com/steveklabnik/semver-parser, version 0.7.0.
// Current version is going through a big rewrite, but is not published yet. Once those changes
// are published, this will probably dissapear.
